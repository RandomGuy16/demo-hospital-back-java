...
public record AppointmentRequest(
        @Schema(example = "3fa85f64-5717-4562-b3fc-2c963f66afa6") @NotNull UUID patientId,

        @Schema(example = "d2719c5d-84d1-43f6-a713-eef8a694be75") @NotNull UUID practitionerId,
